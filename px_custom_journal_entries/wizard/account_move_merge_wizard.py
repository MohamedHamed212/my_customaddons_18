...
#             line_total = item['quantity'] * item['price_unit']
...
#             if payment_type:
#                 payment_type_totals[payment_type] += invoice.amount_total
#
#         for pay_type, total in payment_type_totals.items():
#             merged_lines.append((0, 0, {
#                 'product_id': False,
#                 'quantity': 0.0,
#                 'price_unit': 0.0,
...
#         return self.env.ref('px_custom_journal_entries.action_report_account_move_merge').report_action(self)
